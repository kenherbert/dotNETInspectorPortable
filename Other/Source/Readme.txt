...
user in an INI file next to dotNETInspectorPortable.exe called dotNETInspectorPortable.ini.
...
copy AppNamePortable.ini from this directory to dotNETInspectorPortable.ini next to
dotNETInspectorPortable.exe. The options in the INI file are as follows:
